...
const minibrand3 = require('../../database/minibrand')
const minibrandSeriesNo = 3

const minibrand = minibrand3.filter(minibrand3 => minibrand3.seriesNo.toString().toLowerCase().replace(/\s/g, '') === minibrandSeriesNo.toString().toLowerCase().replace(/\s/g, ''))
