...
const minibrand2 = require('../../database/minibrand')
const minibrandSeriesNo = 2

const minibrand = minibrand2.filter(minibrand2 => minibrand2.seriesNo.toString().toLowerCase().replace(/\s/g, '') === minibrandSeriesNo.toString().toLowerCase().replace(/\s/g, ''))
